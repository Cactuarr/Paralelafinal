...
class MostratPoke extends StatelessWidget {
  final List<Pokemon> pokemones;
  final int next;

  const MostratPoke({super.key, required this.pokemones, required this.next});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          TextButton(
              onPressed: () {PokeApi.getPokemones(context);} ,
              child: Container(
                width: 250,
